...
Le contenu reste celui décrit plus haut — PR, section « Questions ouvertes », état de la CI ; la
FORME, elle, est la même pour tout agent du précis — au plus QUINZE LIGNES :
